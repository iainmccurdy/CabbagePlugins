...
;                  as this is iterative, the amountof actual reverb will increase as the echoes repeat,
...
<Cabbage>
form caption("Multimode Delay")  size(895,125), pluginId("MMDl"), guiMode("queue"), colour(37,50,56)
image                      bounds(0,0,895,125), colour(0,0,0,0), outlineThickness(3), outlineColour("silver"), corners(5)
...
image    bounds(500,  9,210,  1), colour("grey")
...
image    bounds(740,  9,140,  1), colour("grey")
rslider  bounds(740, 15, 70, 90), text("Mix"), channel("mix"), range(0, 1.00, 0.5), $SLIDER_DESIGN
rslider  bounds(810, 15, 70, 90), text("Level"), channel("level"), range(0, 1.00, 0.7), $SLIDER_DESIGN
