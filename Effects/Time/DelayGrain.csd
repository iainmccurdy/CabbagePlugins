...
giTabSize = 2^8
i_         ftgen  1, 0, giTabSize, 20, 2, 1 ;-2, 0
i_         ftgen  2, 0, giTabSize, 5, 1, giTabSize, 0.001 ;-2, 0
...
instr  2                                    ; grain triggering instrument
...
;                                        p1 p2          p3     p4   p5         p6       p7   p8              p9             p10       p11         p12     p13        p14         p15    p16
             schedkwhen        ktrig,0,0,3, kDly+0.0001,kGSize,kptr,kPanSpread,kreverse,kDly,kMinDly+ioffset,kMaxDly+0.0001,kampdecay,klevel*kmix,kwindow,kAmpSpread,kFiltSpread,kTrns1,kTrns2  ; call grain instrument
...
instr  4                                                                     ; output instrument (always on)
...
<CsScore>
i 1 0 0.1
i 2 0   z                                           ; read audio, write to buffers, call grains.
i 4 0   z                                           ; output
</CsScore>
