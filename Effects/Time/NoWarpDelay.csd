...
<Cabbage>
form caption("No-Warp Delay") size(735,135), pluginId("NWDl"), colour(50,50,50), guiMode("queue")
image               bounds(  0,  0,735,135), colour(0,0,0,0), outlineThickness(2), outlineColour("silver"), corners(5)
...
image    bounds(100, 16,110,  1), colour(150,150,150)
button   bounds(130, 10, 50, 13),  text("LINK","LINK"), channel("Link"), textColour("white"), fontColour:0("white"), fontColour:1("black"), latched(1), colour:0(20,20,30), colour:1(200,200,250)
...
rslider  bounds(360, 25, 80, 90),  text("Transpose"), channel("Transpose"),   range(-24, 24, 0, 1, 0.01), textColour("white"), valueTextBox(1),    colour(100, 80, 80,  5) trackerColour("silver")
rslider  bounds(430, 25, 80, 90),  text("Pan L"),      channel("PanL"), range(0, 1, 0), textColour("white"), valueTextBox(1),    colour(100, 80, 80,  5) trackerColour("silver")
rslider  bounds(500, 25, 80, 90),  text("Pan R"),      channel("PanR"), range(0, 1, 1), textColour("white"), valueTextBox(1),    colour(100, 80, 80,  5) trackerColour("silver")
label    bounds(585, 20, 60, 13), text("FFT Size") fontColour("white")
listbox  bounds(585, 35, 60, 80), text("FFTsize"),      channel("FFTsize"), items("512","1024","2048","4096"), value(2), align("centre"), highlightColour(250,250,255), fontColour("DarkGrey")
rslider  bounds(650, 25, 80, 90),  text("Dry/Wet"),      channel("DryWet"), range(0, 1, 0.5), textColour("white"), valueTextBox(1),    colour(100, 80, 80,  5) trackerColour("silver")
