...
; speakers
;label    bounds( 92,192, 16, 16), channel("Spk1"), alpha(1), text("L"), fontColour("Black"), colour("White")
;label    bounds(292,192, 16, 16), channel("Spk2"), alpha(1), text("R"), fontColour("Black"), colour("White")
label    bounds(  0,192, 16, 16), channel("Spk1"), alpha(1), text("L"), fontColour("Black"), colour("White")
label    bounds(384,192, 16, 16), channel("Spk2"), alpha(1), text("R"), fontColour("Black"), colour("White")

; xy pad
xypad bounds( -10, -10,420,484), colour(0,0,0,0), ballColour("White"), channel("X","Y"), rangeX(-1,1,0), rangeY(-1,1,0), alpha(0.7) fontColour(0,0,0,0)
hslider  bounds(  0,400,400, 20), channel("Spacing"), text("Spacing"), range(0, 1, 1), valueTextBox(1)
...
; file player
image bounds( 10,425,890, 70) colour(0,0,0,0), outlineColour("silver"), outlineThickness(1), corners(5)
{
...
soundfiler bounds(  5, 35,880, 30), channel("beg","len"), channel("filer1"),  colour(0, 255, 255, 255), fontColour(160, 160, 160, 255)
...
instr 1
 ...
 kY1             =                0
 kY2             =                0
 kSpacing,kT     cabbageGetValue  "Spacing"
 kX1             =                -1 * kSpacing
 kX2             =                1 * kSpacing
                 cabbageSet       kT, "Spk1", "bounds", 191 - (191 * kSpacing), 192, 16, 16
                 cabbageSet       kT, "Spk2", "bounds", 191 + (191 * kSpacing), 192, 16, 16
