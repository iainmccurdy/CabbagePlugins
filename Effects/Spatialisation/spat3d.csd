...
; speakers
label    bounds( 96,192, 16, 16), channel("left"), colour("White"), text("L"), fontColour("Black")
label    bounds(289,192, 16, 16), channel("right"), colour("White"), text("R"), fontColour("Black")
; head
...
combobox bounds(510, 20, 80, 20), items("Mouse","LFO"), channel("control"), value(1)
