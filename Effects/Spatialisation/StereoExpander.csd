...
<Cabbage>
form caption("Stereo Expander") size(945,640), pluginId("StEx"), guiMode("queue"), colour(50,50,50)
...
hslider  bounds(  0,250,510, 15), channel("RotateStereo"), text("Rotate Stereo"), range(-720,720,0,1,0.1), valueTextBox(1)
hslider  bounds(  0,280,510, 15), channel("StereoWidth"), text("Stereo Width"), range(-720,720,90,1,1), valueTextBox(1)
...
kazim1             init                -45 ; set initial values for i-time pass
kazim2             init                45
kazim3             init                0
kazim4             init                67.5
kazim5             init                225
