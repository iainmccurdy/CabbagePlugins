...
; Title
label bounds(  0,145,400,120), text("LOCSIG"), fontColour("white"), alpha(0.1), colour(0,0,0,0), channel("title")

; speakers
label    bounds(-1000, 84, 32, 32), channel("Spk1"), colour("White"), text("1"), fontColour("Black")
label    bounds(-1000, 84, 32, 32), channel("Spk2"), colour("White"), text("2"), fontColour("Black")
...
label    bounds( 10,100, 80, 13), text("CONTROL"), align("centre")
combobox bounds( 10,115, 80, 20), items("Mouse","LFO"), channel("control"), value(1)
}

; meters
image   bounds(520,105,135, 76), colour(0,0,0,0)
{
...
hslider  bounds(580,110,230, 20), channel("Gain"), text("Gain"), range(0, 10, 1,0.5, 0.001), valueTextBox(1)
...
if kcontrol==1 then ; Mouse - XY Pad
...
; reverb send as part of the opcode
