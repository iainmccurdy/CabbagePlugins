...
; speaker locations
image bounds(410,200,340,210), colour(0,0,0,0), outlineThickness(1), outlineColour("silver")
{
...
instr 101
 ...
 if i(gkNChans)==1 then
  gaFileL         diskin2 gSfilepath,1,iInskip,1
 else
  gaFileL,gaFileR diskin2 gSfilepath,1,iInskip,1
 endif
endin
