...
; speaker locations
image bounds(410,195,340,210), colour(0,0,0,0), outlineThickness(1), outlineColour("silver")
{
...
label    bounds(  8,190, 70, 14), text("PRESET:"), align("right")
combobox bounds( 80,185, 80, 22), channel("Preset"), items("Ring 1","Ring 2","St. Pairs 1","St. Pairs 2"), value(1)
hslider  bounds(170,185,140, 20), channel("ArrScale"), text("Scale"), range(0, 1, 1, 1, 0.001)
}
