...
<Cabbage>
form caption("Multi-Reverb") size(865,100), pluginId("Rvrb"), colour(160,160,170), guiMode("queue")
...
rslider bounds(235, 16, 70, 70), text("Predelay (ms)"),   channel("predelay"), range(0, 300, 0,1,1), $DIAL_STYLE
rslider bounds(310, 16, 70, 70), text("Size"),       channel("fblvl"),    range(0, 1.00, 0.85), $DIAL_STYLE
rslider bounds(385, 16, 70, 70), text("Damping"),    channel("fco"),      range(0, 1.00, 0.6), $DIAL_STYLE
rslider bounds(460, 16, 70, 70), text("Pitch Mod."), channel("pitchm"),   range(0, 20.0, 1, 0.5), $DIAL_STYLE
line    bounds(540,  0,  3,100), colour("silver")
rslider bounds(555, 16, 70, 70), text("HPF"),        channel("hpf"),      range(20, 20000, 20, 0.25,1), $DIAL_STYLE
rslider bounds(630, 16, 70, 70), text("LPF"),      channel("lpf"),      range(20, 20000, 20000, 0.25,1), $DIAL_STYLE
rslider bounds(705, 16, 70, 70), text("Mix"),        channel("mix"),      range(0, 1.00, 0.3), $DIAL_STYLE
rslider bounds(780, 16, 70, 70), text("Level"),      channel("amp"),      range(0, 5.00, 1, 0.5), $DIAL_STYLE
...
; hpf/lpf
if khpf>20 then
 arvbL atone arvbL, khpf
 arvbR atone arvbR, khpf
endif
if klpf<20000 then
 arvbL tone arvbL, klpf
 arvbR tone arvbR, klpf
endif
