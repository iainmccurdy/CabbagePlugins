...
#define DIAL_STYLE  trackerInsideRadius(0.8),  trackerColour(200,200,150), colour(160,160,170), textColour(200,200,150), valueTextBox(1)
...
rslider  bounds(260, 25, 70, 90), text("Damping"),  channel("Damping"),  range(200,18000,18000,0.5,1), $DIAL_STYLE
