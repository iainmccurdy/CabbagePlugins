...
image bounds(0, 60,1460,200), colour(0,0,0,0), outlineThickness(2) ; main area
{
 ...
 {
  ;hslider bounds(  0,  0,260, 20), text("NOTE"),   range(-12,12,0,1,1), textColour("white"), channel("NOTE"), valueTextBox(1)
...
;kNOTE     cabbageGetValue "NOTE" ; not yet implemented
...
/*
          SyncWidgets     "Freq1", "Note1", ftom(kFreq1), mtof(kNote1*semitone(kNOTE))
          SyncWidgets     "Freq2", "Note2", ftom(kFreq2), mtof(kNote2*semitone(kNOTE))
          SyncWidgets     "Freq3", "Note3", ftom(kFreq3), mtof(kNote3*semitone(kNOTE))
          SyncWidgets     "Freq4", "Note4", ftom(kFreq4), mtof(kNote4*semitone(kNOTE))
          SyncWidgets     "Freq5", "Note5", ftom(kFreq5), mtof(kNote5*semitone(kNOTE))
*/
...
a1L wguide1Iter  aL, a(kFreq1*kFREQ*semitone(kSemi1)), kLP1*kLP, kRes1*kRES, i(kType), i(kIter)
a2L wguide1Iter  aL, a(kFreq2*kFREQ*semitone(kSemi2)), kLP2*kLP, kRes2*kRES, i(kType), i(kIter)
a3L wguide1Iter  aL, a(kFreq3*kFREQ*semitone(kSemi3)), kLP3*kLP, kRes3*kRES, i(kType), i(kIter)
a4L wguide1Iter  aL, a(kFreq4*kFREQ*semitone(kSemi4)), kLP4*kLP, kRes4*kRES, i(kType), i(kIter)
a5L wguide1Iter  aL, a(kFreq5*kFREQ*semitone(kSemi5)), kLP5*kLP, kRes5*kRES, i(kType), i(kIter)

a1R wguide1Iter  aR, a(kFreq1*kFREQ*semitone(kSemi1)), kLP1*kLP, kRes1*kRES, i(kType), i(kIter)
a2R wguide1Iter  aR, a(kFreq2*kFREQ*semitone(kSemi2)), kLP2*kLP, kRes2*kRES, i(kType), i(kIter)
a3R wguide1Iter  aR, a(kFreq3*kFREQ*semitone(kSemi3)), kLP3*kLP, kRes3*kRES, i(kType), i(kIter)
a4R wguide1Iter  aR, a(kFreq4*kFREQ*semitone(kSemi4)), kLP4*kLP, kRes4*kRES, i(kType), i(kIter)
a5R wguide1Iter  aR, a(kFreq5*kFREQ*semitone(kSemi5)), kLP5*kLP, kRes5*kRES, i(kType), i(kIter)
rireturn
