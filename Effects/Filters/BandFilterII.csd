...
; This version of the bandpass filter is implemented using separate high-pass and low-pass filters.
; By using this approach, the natures and characters of the two filters can changed independently.
; The cutoffs of these filters can be controlled using the xypad.
; The cutoffs can be controlled by either the XY pad or the hrange sliders.

; For each filter, low-pass/high-pass
; Type 1 = 6dB/oct; atone
; Type 2 = 12dB/oct; buthp
; Type 3 = 24dB/oct; buthp x 2
; Type 4 = 36dB/oct; buthp x 3
; Type 5 = 48dB/oct; buthp x 4
; Type 6 = Resonant; bqrez
...
instr   1
 ...
 ; send XY Pad values to hrange widget
       cabbageSet changed:k(kLim1), "Lim1", "minValue", kLim1  
       cabbageSet changed:k(kLim2), "Lim1", "maxValue", kLim2
 ; read limits from hrange - these are the values actually used by the filters
 kLim1 cabbageGetValue "Lim1"
 kLim2 cabbageGetValue "Lim2"
