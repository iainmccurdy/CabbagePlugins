...
; A selection of bandpass/bandreject filters whose centre frequencies and bandwidths 
;   are controllable from both the XY pad and the horizontal and vertical sliders.
...
instr   1
 ...
 elseif ktype==5 then
  aFiltL      bqrez                aL*0.1, a(kcf), a(1 + ((1-kres)^10 * 99)), 2               ; bandpass
  aFiltR      bqrez                aR*0.1, a(kcf), a(1 + ((1-kres)^10 * 99)), 2
 elseif ktype==6 then
 ...
 elseif ktype==8 then
  aFiltL      zdf_2pole            aL*0.5, a(kcf), a(0.5 + ((1-kres)^3 * 24.5)), 2 ; band-pass 
  aFiltR      zdf_2pole            aR*0.5, a(kcf), a(0.5 + ((1-kres)^3 * 24.5)), 2
 elseif ktype==9 then
 ...
 elseif ktype==10 then
  aFiltL      zdf_2pole            aL*0.15, a(kcf), a(0.5 + ((1-kres)^3 * 24.5)), 6 ; peak
  aFiltR      zdf_2pole            aR*0.15, a(kcf), a(0.5 + ((1-kres)^3 * 24.5)), 6
 endif
