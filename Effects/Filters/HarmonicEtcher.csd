...
<Cabbage>
form caption("Harmonic Etcher"), size(1265,575), colour(90,70,70), pluginId("HaEt"), guiMode("queue")
...
rslider  bounds( 90, 25, 80, 90), text("CPS"), channel("FundCPS"), range(1,  5000, 165, 0.5, 0.1), valueTextBox(1), $SLIDER_DESIGN2, visible(1)
...
if kBandwidthMode == 1 then ; harmonic mode
 ...
 kBWL               =                   iFund * kBW * 4                  ; bandwidth local to this iteration as a musical interval related to the frequency of the fundamental
endif
