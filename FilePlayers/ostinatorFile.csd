...
; Y TO PITCH    - If this is active, the vertical position of the mouse (while left click is held)
...
checkbox bounds( 10, 50,120, 12), channel("Y2Pitch"), text("Y TO PITCH"), colour:0(0,50,0), value(0)
...
if kY2Pitch==1 && kMouseDownLeft==1 && kMouseX>=iOLX && kMouseX<=(iOLX+iOLWidth) && kMouseY>=iOLY && kMouseY<=(iOLY+iOLHeight) then
 kNormVal      =              1 - (kMouseY-iOLY)/iOLHeight
               cabbageSetValue "Pitch", scale:k(kNormVal^2, 8.00, 0.125)
endif
