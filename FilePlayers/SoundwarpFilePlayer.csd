...
<Cabbage>
form caption("Soundwarp File Player") size(1275,390), colour( 30, 90, 60), pluginId("SWPl"), guiMode("queue")

soundfiler bounds(  5,  5,1265,155), channel("beg","len"), colour(0, 255, 255, 255), fontColour(160, 160, 160, 255)
label      bounds( 10, 10,560, 14), text(""), align("left"), colour(0,0,0,0), fontColour(200,200,200), channel("stringbox")
image      bounds(  5,  5,  1,155), channel("wiper")

hslider    bounds(  0,158,1275, 20), channel("ptr"), range(0,1.00, 0.5,1,0.001), colour( 50,110, 80), trackerColour(150,210,180), visible(0), markerColour("white")
...
image      bounds(575,197,230, 90), colour(0,0,0,0), channel("PtrID"), visible(0)
{
...
image      bounds(800,175,160,120), colour(0,0,0,0), outlineThickness(1), corners(5), outlineColour(200,200,200)
{
...
image      bounds(970,175,300,120), colour(0,0,0,0), outlineThickness(1), corners(5), outlineColour(200,200,200)
{
...
keyboard   bounds(  15,300,1080, 75)
rslider    bounds(1090,295, 90, 90), channel("level"),     range(  0,  1.00, 0.4, 0.5),      colour( 50,110, 80), text("Level"),     textColour("white"), trackerColour(150,210,180), valueTextBox(1), fontColour("white")

label    bounds(  5,376,120, 13), text("Iain McCurdy |2014|"), align("left"), fontColour("LightGrey")
</Cabbage>
