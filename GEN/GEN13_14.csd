...
; TONE      - turn the sine wave oscillator on or off. When off, audio is from the live stereo input
...
if ktone==1 then
aL        poscil               a(kampIn),kfreq
aR        poscil               a(kampIn),kfreq
else
aL        inch                 1
aR        inch                 2
endif
...
; waveshaping
aWSL      tablei               ((aL*0.5) + 0.5)^kpower, 1, 1
aWSL      *=                   a(kampOut)
aWSR      tablei               ((aR*0.5) + 0.5)^kpower, 1, 1
aWSR      *=                   a(kampOut)

; DC Block
kdcblock  cabbageGetValue      "dcblock"
if kdcblock==1 then
 aWSL     dcblock2             aWSL, 2048
 aWSR     dcblock2             aWSR, 2048
endif
