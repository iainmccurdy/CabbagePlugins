...
; non-MIDI control to be completed
...
;label    bounds(  5,287, 80, 12), text("Pitch Control")
;combobox bounds(  5,300, 80, 25), channel("pitchCtrl"), value(1), text("MIDI", "Dial")
;rslider  bounds( 90,265, 70, 90), text("Freq."), channel("freq"), range(20, 5000, 200, 0.5), $RSLIDER_DESIGN1

;keyboard bounds(170, 265, 615, 85)
keyboard bounds( 5, 265, 780, 85)

label    bounds( 5,355,120, 11), text("Iain McCurdy |2012|"), fontColour("silver"), align("left")
...
;bass a e i o u
girtos29         ftgen                 0,0,-5,-2,    600/600, 1040/600, 2250/600, 2450/600, 2750/600
girtos30         ftgen                 0,0,-5,-2,    400/400, 1620/400, 2400/400, 2800/400, 3100/400
girtos31         ftgen                 0,0,-5,-2,    250/250, 1750/250, 2600/250, 3050/250, 3340/250
girtos32         ftgen                 0,0,-5,-2,    400/400 ,750/400, 2400/400, 2600/400, 2900/400
girtos33         ftgen                 0,0,-5,-2,    350/350, 600/350, 2400/350, 2675/350, 2950/350
...
;if ivalue==1 then ; MIDI
    inum         =                     p4                 ; note number
;else              ; non-MIDI
    ;inum         =           55;          ftom:i(cabbageGetValue:i("freq"))
    ;print inum
;endif
    ...
    /* monophonic */     kNoteTrig  changed      gknum                         ; ...GENERATE A TRIGGER IS A NEW NOTE NUMBER IS GENERATED (FROM INSTR. 1)
     gkNoteTrig  =                     0
     gkOldNum    init                  inum                                      ; OLD NOTE NUMBER = FIRST NOTE NUMBER UPON INITIAL NOTE BEING PLAYED 
    ...
    /* polyphonic */
     knum        =                     inum                                    ; base note number read from p4    
